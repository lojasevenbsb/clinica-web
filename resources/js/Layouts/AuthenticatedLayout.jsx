                ...
                <aside className="hidden md:flex flex-col w-64 p-4 bg-white dark:bg-stone-900 rounded-r-2xl h-screen shadow-sm space-y-2 sticky top-0 overflow-y-auto">
                    ...
                    <nav className="flex-1 space-y-1">
                        ...
                        <Link
                            ...
                            className={`flex items-center gap-3 px-4 py-3 ease-out duration-200 rounded-lg ${route().current('settings.*') ? 'bg-[#466250]/10 text-[#466250] font-bold' : 'text-stone-600 hover:text-[#466250] hover:bg-stone-50 dark:hover:bg-stone-800'}`}
                        >
                            <span className="material-symbols-outlined" style={route().current('settings.*') ? { fontVariationSettings: "'FILL' 1" } : {}}>settings</span>
                            <span className="font-manrope body-md">Configurações</span>
                        </Link>
                    </nav>
