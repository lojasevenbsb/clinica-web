    ...
    return (
        <AuthenticatedLayout>
            ...
            <section className="mb-8">
                <h1 className="text-3xl font-extrabold tracking-tight text-[#466250]">Configurações da Agenda</h1>
                <p className="text-stone-500 text-sm">Defina os dias e horários de funcionamento da clínica para a agenda.</p>
            </section>
